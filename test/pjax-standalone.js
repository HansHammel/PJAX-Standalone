...
(function(){ 
	...
	if(!internal.is_supported) {
		...
		var pjax_shell = {
			"connect": function() { },
			"invoke": function() {
				document.location = (arguments.length === 2) ? arguments[0] : arguments.url;
			} 
		};
		// AMD support
	 ...
	 * @return Element to append to our page.
	 */
	 ...
	 * @scope private
	 * @param options
	 * @return boolean | valid options object
	 */
